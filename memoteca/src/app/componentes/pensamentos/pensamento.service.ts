...
export class PensamentoService {
  ...
  public listar(pagina: number, filtro: string = '', favoritos: boolean = false): Observable<PensamentoModel[]> {
  ...
  public mudarFavorito(pensamento: PensamentoModel): Observable<PensamentoModel> {
